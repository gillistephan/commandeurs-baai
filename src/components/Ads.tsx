...
import { Box, Center, HTMLChakraProps, Heading, SimpleGrid, chakra, Image } from "@chakra-ui/react";

export const Logo = (props: HTMLChakraProps<"svg">) => (
  <chakra.svg h="0.8em" viewBox="0 0 140 28" fill="none" {...props}>
    <path fill="#00a7e0" d="M3.883,3.4029h-3.888v18.329h11.023v-3.222H3.883V3.4029z" />
  ...
  return (
    <Box as="section" py={{ base: "12", md: "40" }}>
      <Box maxW={{ md: "7xl" }} mx="auto" px={{ base: "8", lg: 0 }}>
        <Heading color="gray.700" align="center" fontWeight="extrabold" maxW="md" mx="auto">
          Our Sponsors
        </Heading>
        <SimpleGrid columns={{ base: 1, sm: 2, lg: 3 }} mt="8" spacing="6" color="inherit">
          <Center py="2" px="8" rounded={{ md: "lg" }} bg="gray.50" as="a" cursor="pointer" href="https://childfirst-foundation.com/">
