  ...
  return (
    <Box as="footer" role="contentinfo" py="6" bg="blue.500" color="white">
      <Flex direction={{ base: "column", md: "row" }} maxW={{ base: "xl", md: "7xl" }} mx="auto" px={{ base: "6", md: "8" }} align="center">
        ...
        >
          <Text>&copy; {new Date().getFullYear()} Ryan De Jongh Charity Foundation | Villapark Girouette 69, Willemstad</Text>
        </Stack>
        <ButtonGroup marginStart={{ md: "auto" }} color="white" variant="ghost">
          <IconButton
            ...
            icon={<FaFacebook />}
          />
          <IconButton as="a" href="http://www.instagram.com/Commandeursbaai" aria-label="Instagram" icon={<FaInstagram />} />
        </ButtonGroup>
      </Flex>
    </Box>
  );
