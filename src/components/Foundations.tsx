...
export const Foundations = () => (
  <Box as="section" maxW="8xl" mx="auto" px={{ base: "6", md: "8" }} pt={{ base: "12", md: "40" }} pb={{ base: "12", md: "20" }}>
    <Stack spacing="8" direction={{ base: "column", md: "row" }} divider={<StackDivider />}>
      <Stack direction="column" flex="1">
        <Heading color="blue.500" size="2xl" fontWeight="extrabold" lineHeight="normal">
      ...
      <Stack direction="column" flex="1">
        ...
        <Text fontSize="lg" color="gray.700">
          We dedicate ourselves to the empowerment of especially our youth including sports, education and nature to implement preservation,
          the country nature as well as the marine environment.
        </Text>
      </Stack>
    </Stack>
  </Box>
