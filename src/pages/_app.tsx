  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="We kayak for Nature | Passion and Love for Nature" />
        <meta
          property="og:description"
          content="On Saturday, 4th of September 2021 we are going to cross from Curaçao to Aruba by kayak. | Bringing awareness of the need to protect our delicate ecosystems in Aruba with conservation of Commandeurs Baai as a focal point."
        />
